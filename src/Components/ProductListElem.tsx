...
`;
export default ({product,setproduct,setmodalVisible}:{
    product:Product,setproduct: React.Dispatch<any>,setmodalVisible:React.Dispatch<React.SetStateAction<boolean>>})=>{
    const clickBtn =()=>{
        setproduct(product);
